...
* Como este caso de uso possuia depêndencias a casos de usos desenvolvidos no Sprint 2, algumas alterações tiveram de ser feita, principalmente na Classe AGV Task que passou de 'Value Object' para 'Entity'.
